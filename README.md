...
- 영수증철은 A4 세로 한 장에 최대 6개를 세로 우선으로 배치합니다. 각 칸 위에는 항목·영수증 번호·지출 내용을 표시하고, 오프라인 영수증은 작은 중앙 안내 위에 실물을 붙입니다.
...
- 진행 현황에서 수입 관리 → 지출 입력 → 영수증 준비 → 정산 확인 → Excel·영수증철 산출물 생성 순서를 안내합니다.
